  ...
  <a-form ref="formRef" :model="formState" @submit="handleSubmit">
    <a-row class="form-row" :gutter="16">
      <a-col :lg="6" :md="12" :sm="24">
        ...
        >
          <a-input v-model:value="formState.name" placeholder="Please enter repository name" />
        </a-form-item>
      </a-col>
      <a-col :xl="{ span: 7, offset: 1 }" :lg="{ span: 8 }" :md="{ span: 12 }" :sm="24">
        <a-form-item
          name="url"
          :rules="[{ required: true, message: 'Please enter repository address' }]"
          label="Repository Address"
        >
          <a-input v-model:value="formState.url" placeholder="Please enter repository address" />
        </a-form-item>
      </a-col>
      <a-col :xl="{ span: 9, offset: 1 }" :lg="{ span: 10 }" :md="{ span: 24 }" :sm="24">
        <a-form-item
          ...
          label="Repository Administrator"
        >
          <a-select
      ...
      <a-col :xl="{ span: 9, offset: 1 }" :lg="{ span: 10 }" :md="{ span: 24 }" :sm="24">
        ...
        >
          <a-select
            ...
            placeholder="Please select repository type"
          >
