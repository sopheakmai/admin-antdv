...
// Removed getQueryParam import - using useRoute instead
...
async function submit() {
  ...
  try {
    ...
    // Get current redirect link if exists, navigate to redirect address
...
<template>
  <div class="login-container">
    <div absolute z-10 h-screen w-screen>
    ...
    <div class="login-content flex-center">
      <div class="ant-pro-form-login-main rounded">
        <!-- Login header -->
        <div
          class="mb-[2px] h-15 flex-between px-4"
        >
          <div class="flex-end">
          ...
          <div class="login-lang relative z-11 flex-center">
            <span
